# MUONNOI FULL DEV MASTER PACKAGE · 2026-05-11

## Purpose
This index is the read entry for Product, Web, Docs, Mobile, API, Platform, Security, Legal, Operations and QA.

It unifies the old mobile package, the public launch package, the Life Quest OS package, DNS/subdomain status, and the next-phase infrastructure plan.

## Mandatory read order
1. `docs/launch/MUONNOI_UNIFIED_NEXT_PHASE_MASTER_PLAN_2026.md`
2. `docs/brand/MUONNOI_BRANDPRO_ADOPTION_PLAN_2026.md`
3. `docs/brand/MUONNOI_BRAND_STYLE_LOCK_2026.md`
4. `docs/brand/MUONNOI_BRAND_ARCHITECTURE_AND_SUBDOMAIN_RULES_2026.md`
5. `docs/brand/MUONNOI_VERBAL_IDENTITY_AND_BILINGUAL_MESSAGING_2026.md`
6. `docs/brand/MUONNOI_VISUAL_IDENTITY_LOGO_AND_TOKENS_2026.md`
7. `docs/brand/MUONNOI_BRAND_GUARDIAN_AND_QA_GATE_2026.md`
8. `docs/launch/MUONNOI_PUBLIC_LAUNCH_DOCS_AND_SUBDOMAIN_PACKAGE_2026.md`
9. `docs/launch/MUONNOI_PUBLIC_ANNOUNCEMENT_2026.md`
10. `docs/launch/DEV_HANDOFF_PUBLIC_PAGES_MUONNOI_2026.md`
